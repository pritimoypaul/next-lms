...
module.exports = {
  ...
  darkMode: "class", // Change from "selector" to "class" for Next.js
  theme: {
    container: {
      center: true,
    },
    ...
    extend: {
      ...
      colors: {
        ...
        danger: { DEFAULT: "#FF4626", 200: "#ff462633" },
        warning: { DEFAULT: "#FFA305" },
        success: { DEFAULT: "#66CC33" },
        info: { DEFAULT: "#498CFF", 200: "#EAF2FF" },
        disable: { DEFAULT: "#868686" },
        light: { DEFAULT: "#19213D" },
        pink: { DEFAULT: "#D777F9" },
        extra: { DEFAULT: "#18DAB5" },
        form: "#E7E7E7",
        blog: "#FAFAFA",
        orange: "#EC8B00",
        ...
        dark: {
          body: "#000011",
          card: { DEFAULT: "#04041D", two: "#090927", shade: "#151541" },
          text: { DEFAULT: "#D7D7D7", two: "#A0A0A0" },
          border: {
            DEFAULT: "#212146",
            two: "#111133",
            three: "#13133D",
      ...
      backgroundImage: {
        ...
        "task-before": "linear-gradient(#5F71FA, #7D5DFE,#76D466)",
